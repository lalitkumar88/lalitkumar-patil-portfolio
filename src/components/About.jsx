...
const texts = [
  ...
  "I have a selective memory when it comes to cricket stats (again, which is vanishing with the careers of Rohit and Virat). Ask me about any match from 10 years ago, and I’ll have a fact for you. Those two are my cricket heroes, and yes, I know every run they've ever scored (ahh, not really). And I enjoy other sports too, and I'm sure, you’ll someday (after 100 years) catch me winning medals in badminton and volleyball.",
  ...
  "I’ve been on a quest to reduce screen time to just 1–2 hours a day. You won’t see me glued to my phone during dinner (unless I'm planning next trip). I prefer wandering in nature or reading something that expands my mind, not my Instagram feed.",
